...
Learn how to update your docs locally and deploy them to the public like this is done by me in my repo.
This is just the start look into this one. chnage here 
